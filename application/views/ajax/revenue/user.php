...
<table class="table table-bordered table-striped">
    ...
    <?php if (isset($_list_users) && count($_list_users)) :
        foreach ($_list_users as $key => $item) :
            ...
            <tr>
                <td style="text-align: center;">
                    <i style="color: #478fca!important;" title="Chi tiết đơn hàng"
                                                   ...
                                                   class="fa fa-plus-circle i-list-order-<?php echo $item['user_init']?>">

                    </i>
                    <i style="color: #478fca!important;" title="Chi tiết đơn hàng"
                       onclick="cms_show_list_order(<?php echo $item['user_init'];?>)"
                       class="fa fa-minus-circle i-hide i-list-order-<?php echo $item['user_init']?>">
                    </i>
                </td>
            ...
            <tr class="tr-hide" id="tr-list-order-<?php echo $item['user_init']?>">
                <td colspan="15">
                    <div class="tabbable">

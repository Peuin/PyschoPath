    ...
    <?php if (isset($_list_orders) && count($_list_orders)) :
        foreach ($_list_orders as $key => $item) :
            ...
            <tr>
                ...
                <td class="text-center"><input id="receipt_money-<?php echo $item['ID']; ?>" class="form-control txtMoney" type="text" placeholder="Số tiền thu""></td>
                <td class="text-center"><button type="button" class="btn btn-primary" onclick="save_receipt_order_in_customer(<?php echo $item['ID']; ?>);" title="Đồng ý">
